...
public class BaiduASRDigitalDialog {

//extends BaiduASRDialog {
...
//        mContentRoot = View.inflate(this, getResources().getIdentifier("bdspeech_digital_layout", "layout", getPackageName()), null);
...
//            ViewGroup.LayoutParams param = new FrameLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT);
...
//        final Integer buttonNormalBgName = getResources().getIdentifier("bdspeech_btn_normal", "drawable", getPackageName());
//        final Integer buttonPressedBgName = getResources().getIdentifier("bdspeech_btn_pressed", "drawable", getPackageName());
//        Integer leftButtonNormalBgName = null;
//        Integer leftButtonPressedBgName = null;
//        final Integer rightButtonNormalBgName = getResources().getIdentifier("bdspeech_right_normal", "drawable", getPackageName());
//        final Integer rightButtonPressedBgName = getResources().getIdentifier("bdspeech_right_pressed", "drawable", getPackageName());
//        Integer bgName = null;
//
//
//        // 按下、不可用、其它状态颜色
...
//            leftButtonNormalBgName = getResources().getIdentifier("bdspeech_left_deep_normal", "drawable", getPackageName());
//            leftButtonPressedBgName = getResources().getIdentifier("bdspeech_left_deep_pressed", "drawable", getPackageName());
//
//            buttonRecognizingBgName = getResources().getIdentifier("bdspeech_btn_recognizing_deep", "drawable", getPackageName());
//
//            colors[0] = 0xffffffff;
//            colors[1] = 0xff4d4d4d;
//            colors[2] = 0xffffffff;
//            colors_reverse[0] = 0xffffffff;
//            colors_reverse[1] = 0xff4d4d4d;
...
//            }, getResources().getDrawable(getResources().getIdentifier("bdspeech_help_pressed_deep", "drawable", getPackageName())));
//            mHelpButtonBg.addState(new int[]{}, getResources().getDrawable(getResources().getIdentifier("bdspeech_help_deep", "drawable", getPackageName())));
//        } else {
//            bgName = getResources().getIdentifier("bdspeech_digital_bg", "drawable", getPackageName());
//            leftButtonNormalBgName = getResources().getIdentifier("bdspeech_left_normal", "drawable", getPackageName());
//            leftButtonPressedBgName = getResources().getIdentifier("bdspeech_left_pressed", "drawable", getPackageName());
//
//            buttonRecognizingBgName = getResources().getIdentifier("bdspeech_btn_recognizing", "drawable", getPackageName());
//
//            colors[0] = 0xff474747;
//            colors[1] = 0xffe8e8e8;
//            colors[2] = 0xff474747;
...
//            mHelpButtonBg.addState(new int[]{
//                    android.R.attr.state_pressed
//            }, getResources().getDrawable(getResources().getIdentifier("bdspeech_help_pressed_light", "drawable", getPackageName())));
//            mHelpButtonBg.addState(new int[]{},
//                    getResources().getDrawable(getResources().getIdentifier("bdspeech_help_light", "drawable", getPackageName())));
//        }
//
